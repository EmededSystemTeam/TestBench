...
HD_PWD='C:/zynq_book/Meffects_constants_testing_3/Meffects_constants_testing_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log effects_loop_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source effects_loop_wrapper.tcl -notrace
