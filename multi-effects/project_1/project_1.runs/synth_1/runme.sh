...
HD_PWD='C:/zynq_book/Meffects_constants_testing_3/Meffects_constants_testing_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log effects_loop_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source effects_loop_wrapper.tcl
