...
################################################################
# This is a generated script based on design: effects_loop
#
...
# source effects_loop_script.tcl
...
proc create_root_design { parentCell } {
  ...
  set butn_in [ create_bd_port -dir I -from 0 -to 2 butn_in ]

  # Create instance: Distortion_0, and set properties
  set Distortion_0 [ create_bd_cell -type ip -vlnv VL:user:Distortion:1.0 Distortion_0 ]

  # Create instance: MCLK_gen_0, and set properties
  set MCLK_gen_0 [ create_bd_cell -type ip -vlnv VL:user:MCLK_gen:1.0 MCLK_gen_0 ]

  # Create instance: PL_to_PS_0, and set properties
  set PL_to_PS_0 [ create_bd_cell -type ip -vlnv VL:user:PL_to_PS:1.0 PL_to_PS_0 ]

  # Create instance: PS_to_PL_0, and set properties
  set PS_to_PL_0 [ create_bd_cell -type ip -vlnv VL:user:PS_to_PL:1.0 PS_to_PL_0 ]

  # Create instance: clk_slow_0, and set properties
  set clk_slow_0 [ create_bd_cell -type ip -vlnv VL:user:clk_slow:1.0 clk_slow_0 ]

  # Create instance: control_0, and set properties
  set control_0 [ create_bd_cell -type ip -vlnv VL:user:control:1.0 control_0 ]

  # Create instance: delay_0, and set properties
  set delay_0 [ create_bd_cell -type ip -vlnv VL:user:delay:1.0 delay_0 ]

  # Create instance: octaver_0, and set properties
  set octaver_0 [ create_bd_cell -type ip -vlnv VL:user:octaver:1.0 octaver_0 ]
...
CONFIG.NUM_MI {8} \
  ...
  set trem_0 [ create_bd_cell -type ip -vlnv VL:user:trem:1.0 trem_0 ]
...
CONFIG.CONST_VAL {0} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI] [get_bd_intf_pins zed_audio_ctrl_0/S_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins PL_to_PS_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M03_AXI [get_bd_intf_pins PS_to_PL_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M03_AXI]

  # Create port connections
  connect_bd_net -net Clk_div_0_clk_out [get_bd_ports MCLK] [get_bd_pins MCLK_gen_0/clk_out] [get_bd_pins clk_slow_0/clk_in]
  connect_bd_net -net Distortion_0_y [get_bd_pins Distortion_0/y] [get_bd_pins octaver_0/x]
  connect_bd_net -net PS_to_PL_0_AXI_to_PL [get_bd_pins Distortion_0/x] [get_bd_pins PS_to_PL_0/AXI_to_PL]
  connect_bd_net -net SDATA_I_1 [get_bd_ports SDATA_I] [get_bd_pins zed_audio_ctrl_0/SDATA_I]
  connect_bd_net -net Switches_1 [get_bd_ports Switches] [get_bd_pins control_0/Switches]
  connect_bd_net -net butn_in_1 [get_bd_ports butn_in] [get_bd_pins control_0/butn_in]
  connect_bd_net -net clk_slow_0_clk1hz5 [get_bd_pins clk_slow_0/clk1hz5] [get_bd_pins control_0/clk_1hz5]
  connect_bd_net -net clk_slow_0_clk_12hz [get_bd_pins clk_slow_0/clk_12hz] [get_bd_pins control_0/clk_12hz]
  connect_bd_net -net clk_slow_0_clk_190hz [get_bd_pins clk_slow_0/clk_190hz] [get_bd_pins trem_0/clk_190]
  connect_bd_net -net clk_slow_0_clk_380hz [get_bd_pins clk_slow_0/clk_380hz] [get_bd_pins trem_0/clk_380]
  connect_bd_net -net clk_slow_0_clk_48hz [get_bd_pins clk_slow_0/clk_48hz] [get_bd_pins trem_0/clk_48hz]
  connect_bd_net -net clk_slow_0_clk_95hz [get_bd_pins clk_slow_0/clk_95hz] [get_bd_pins trem_0/clk_95]
  connect_bd_net -net control_0_En [get_bd_pins Distortion_0/en] [get_bd_pins control_0/en] [get_bd_pins delay_0/en] [get_bd_pins octaver_0/en] [get_bd_pins trem_0/en]
  connect_bd_net -net control_0_Leds [get_bd_ports Leds] [get_bd_pins control_0/Leds]
  connect_bd_net -net control_0_options0 [get_bd_pins Distortion_0/options] [get_bd_pins control_0/options0]
  connect_bd_net -net control_0_options1 [get_bd_pins control_0/options1] [get_bd_pins octaver_0/options]
  connect_bd_net -net control_0_options2 [get_bd_pins control_0/options2] [get_bd_pins trem_0/options]
  connect_bd_net -net control_0_options3 [get_bd_pins control_0/options3] [get_bd_pins delay_0/options]
  connect_bd_net -net delay_0_y [get_bd_pins PL_to_PS_0/AXI_from_PL] [get_bd_pins delay_0/y]
  connect_bd_net -net octaver_0_y [get_bd_pins octaver_0/y] [get_bd_pins trem_0/x]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins MCLK_gen_0/clk_in] [get_bd_pins PL_to_PS_0/s00_axi_aclk] [get_bd_pins PS_to_PL_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/M05_ACLK] [get_bd_pins processing_system7_0_axi_periph/M06_ACLK] [get_bd_pins processing_system7_0_axi_periph/M07_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins zed_audio_ctrl_0/S_AXI_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins PL_to_PS_0/s00_axi_aresetn] [get_bd_pins PS_to_PL_0/s00_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M06_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M07_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins zed_audio_ctrl_0/S_AXI_ARESETN]
  connect_bd_net -net trem_0_y [get_bd_pins delay_0/x] [get_bd_pins trem_0/y]
  ...
  connect_bd_net -net zed_audio_ctrl_0_LRCLK [get_bd_ports LRCLK] [get_bd_pins Distortion_0/clk_48] [get_bd_pins delay_0/clk_48] [get_bd_pins octaver_0/clk_48] [get_bd_pins trem_0/clk_48] [get_bd_pins zed_audio_ctrl_0/LRCLK]
  connect_bd_net -net zed_audio_ctrl_0_SDATA_O [get_bd_ports SDATA_O] [get_bd_pins zed_audio_ctrl_0/SDATA_O]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PL_to_PS_0/S00_AXI/S00_AXI_reg] SEG_PL_to_PS_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PS_to_PL_0/S00_AXI/S00_AXI_reg] SEG_PS_to_PL_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00004000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs zed_audio_ctrl_0/S_AXI/reg0] SEG_zed_audio_ctrl_0_reg0
...
preplace port MCLK -pg 1 -y 170 -defaultsOSRD
preplace port SDATA_O -pg 1 -y 240 -defaultsOSRD
preplace port BCLK -pg 1 -y 220 -defaultsOSRD
preplace port IIC_0 -pg 1 -y 480 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 500 -defaultsOSRD
preplace port LRCLK -pg 1 -y 190 -defaultsOSRD
preplace port SDATA_I -pg 1 -y 760 -defaultsOSRD
preplace portBus butn_in -pg 1 -y 330 -defaultsOSRD
preplace portBus addrbit0 -pg 1 -y 80 -defaultsOSRD
preplace portBus addrbit1 -pg 1 -y 100 -defaultsOSRD
preplace portBus Leds -pg 1 -y 140 -defaultsOSRD
preplace portBus Switches -pg 1 -y 350 -defaultsOSRD
preplace inst clk_slow_0 -pg 1 -lvl 3 -y 500 -defaultsOSRD
preplace inst zed_audio_ctrl_0 -pg 1 -lvl 2 -y 600 -defaultsOSRD
preplace inst trem_0 -pg 1 -lvl 7 -y 280 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 2 -y 100 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 2 -y 850 -defaultsOSRD
preplace inst Distortion_0 -pg 1 -lvl 5 -y 290 -defaultsOSRD
preplace inst delay_0 -pg 1 -lvl 8 -y 290 -defaultsOSRD
preplace inst octaver_0 -pg 1 -lvl 6 -y 270 -defaultsOSRD
preplace inst PS_to_PL_0 -pg 1 -lvl 2 -y 350 -defaultsOSRD
preplace inst PL_to_PS_0 -pg 1 -lvl 9 -y 300 -defaultsOSRD
preplace inst control_0 -pg 1 -lvl 4 -y 480 -defaultsOSRD
preplace inst MCLK_gen_0 -pg 1 -lvl 2 -y 710 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 1 -y 960 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 510 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 9 480 420 NJ 380 NJ 380 NJ 450 NJ 450 NJ 450 NJ 450 NJ 450 NJ
preplace netloc Switches_1 1 0 4 NJ 350 NJ 460 NJ 350 NJ
preplace netloc control_0_En 1 4 4 1520 380 1870 350 2230 400 2520
preplace netloc processing_system7_0_axi_periph_M03_AXI 1 1 1 460
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 1 1 500
preplace netloc processing_system7_0_M_AXI_GP0 1 0 2 NJ 360 NJ
preplace netloc control_0_options0 1 4 1 1510
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 430
preplace netloc processing_system7_0_IIC_0 1 1 9 N 450 NJ 360 NJ 360 NJ 480 NJ 480 NJ 480 NJ 480 NJ 480 NJ
preplace netloc control_0_options1 1 4 2 NJ 210 1880
preplace netloc processing_system7_0_axi_periph_M02_AXI 1 1 8 NJ 480 NJ 320 NJ 320 NJ 460 NJ 460 N 460 N 460 2850
preplace netloc control_0_options2 1 4 3 1550 410 NJ 380 NJ
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 0 9 30 670 450 490 960 330 NJ 330 1530 440 NJ 440 N 440 2530 370 2870
preplace netloc clk_slow_0_clk_12hz 1 3 1 1150
preplace netloc clk_slow_0_clk_190hz 1 3 4 1130 140 NJ 140 NJ 140 2230
preplace netloc clk_slow_0_clk_95hz 1 3 4 1120 130 NJ 130 NJ 130 2220
preplace netloc control_0_options3 1 4 4 NJ 170 NJ 170 NJ 150 NJ
preplace netloc delay_0_y 1 8 1 NJ
preplace netloc xlconstant_0_dout 1 2 8 NJ 100 NJ 100 NJ 100 NJ 100 NJ 100 NJ 100 NJ 100 NJ
preplace netloc zed_audio_ctrl_0_LRCLK 1 2 8 NJ 280 NJ 280 NJ 190 1890 190 NJ 160 NJ 190 NJ 190 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 9 N 430 NJ 370 NJ 370 NJ 430 NJ 430 NJ 430 NJ 430 NJ 430 NJ
preplace netloc control_0_Leds 1 4 6 1440 160 NJ 160 NJ 140 NJ 140 NJ 140 NJ
preplace netloc clk_slow_0_clk1hz5 1 3 1 1190
preplace netloc zed_audio_ctrl_0_SDATA_O 1 2 8 NJ 180 NJ 180 NJ 180 NJ 180 NJ 130 NJ 130 NJ 130 NJ
preplace netloc zed_audio_ctrl_0_BCLK 1 2 8 940 340 NJ 340 NJ 420 NJ 420 NJ 420 NJ 210 NJ 210 NJ
preplace netloc octaver_0_y 1 6 1 2240
preplace netloc clk_slow_0_clk_48hz 1 3 4 1180 350 NJ 370 NJ 370 2250
preplace netloc SDATA_I_1 1 0 2 NJ 690 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 0 3 50 700 NJ 760 900
preplace netloc processing_system7_0_FCLK_CLK0 1 0 9 20 660 490 470 850 310 NJ 310 NJ 400 NJ 400 2220 410 N 410 2860
preplace netloc trem_0_y 1 7 1 2500
preplace netloc PS_to_PL_0_AXI_to_PL 1 2 3 NJ 260 NJ 260 NJ
preplace netloc butn_in_1 1 0 4 NJ 330 NJ 440 NJ 400 NJ
preplace netloc Distortion_0_y 1 5 1 1870
preplace netloc clk_slow_0_clk_380hz 1 3 4 1140 150 NJ 150 N 150 2260
preplace netloc Clk_div_0_clk_out 1 2 8 NJ 120 NJ 120 NJ 120 NJ 120 NJ 120 NJ 120 NJ 120 NJ
levelinfo -pg 1 -10 240 680 1040 1330 1780 2130 2410 2760 3020 3180 -top -260 -bot 1260
",
}
