...
HD_PWD='C:/Users/tabis/OneDrive/Desktop/CE-Project/music_effect/music_effect.runs/music_effect_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log music_effect_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source music_effect_xbar_0.tcl
