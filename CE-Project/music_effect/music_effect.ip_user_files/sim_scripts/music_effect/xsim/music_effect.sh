...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_13 -L processing_system7_vip_v1_0_15 -L xil_defaultlib -L generic_baseblocks_v2_1_0 -L axi_register_slice_v2_1_27 -L fifo_generator_v13_2_7 -L axi_data_fifo_v2_1_26 -L axi_crossbar_v2_1_28 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L axi_i2s_adi_v1_00_a -L adi_common_v1_00_a -L axi_protocol_converter_v2_1_27 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot music_effect xil_defaultlib.music_effect xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  music_effect -key {Behavioral:sim_1:Functional:music_effect} -tclbatch cmd.tcl -protoinst "protoinst_files/music_effect.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb music_effect.wdb xsim.dir)
