...
HD_PWD='/home/louis/Documents/5AEsisar/CE515_soc/ProjetGuitareEffect/TestBench/ManageIP/GuitareEffect_IP_Manage/GuitareEffect_IP_Manage.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log User_IHM_control_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source User_IHM_control_wrapper.tcl -notrace
