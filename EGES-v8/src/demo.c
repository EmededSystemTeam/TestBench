...
int main(void)
{
    ...
    while(1) {
    	//Take btn value
    	//*(controlBaseAdress_ptr+0) =0;
    	Xil_Out32(XPAR_CONTROL_1_S00_AXI_BASEADDR,0);
    	//fnUpdateFromSwitches(&sUserIO);
//    	dwSw = XGpio_DiscreteRead(&sUserIO, Switch_CHANNEL);
//    	//*(controlBaseAdress_ptr+1) = dwSw;
//    	Xil_Out32(XPAR_CONTROL_1_S00_AXI_BASEADDR+0x1,dwSw);
